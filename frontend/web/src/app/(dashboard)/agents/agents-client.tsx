  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div><h1 className="text-2xl font-bold">🤖 AI Agents</h1><p className="text-muted-foreground text-sm mt-1">Build custom AI assistants.</p></div>
        <button onClick={() => setShow(true)} className="px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-lg text-sm font-medium">+ Create Agent</button>
      </div>
