    ...
    <div className="min-h-screen bg-[#0A0F2E] text-white">
      <nav className="border-b border-white/10 px-6 py-4 flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          <a href="/login" className="text-sm text-white/70 hover:text-white">Sign in</a>
          <a href="/register" className="px-4 py-2 bg-violet-600 hover:bg-violet-700 rounded-lg text-sm font-medium transition-colors inline-block">Get Started Free</a>
        </div>
      </nav>
