    ...
    <div className="min-h-screen bg-[#0A0F2E] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
          ...
          <p className="text-center text-sm text-white/40 mt-6">Don&apos;t have an account? <Link href="/register" className="text-violet-400 hover:text-violet-300">Sign up free</Link></p>
        </div>
      </div>
    </div>
  );
